...
import stripe
STRIPE_SECRET_KEY = getattr(settings, "STRIPE_SECRET_KEY" ,"sk_test_x33KBxusHfdA7eXMyaHdJp6i")
STRIPE_PUB_KEY = getattr(settings, "STRIPE_PUB_KEY", 'pk_test_oXY7CAW0bxemHlmDIvnpw4TB')
